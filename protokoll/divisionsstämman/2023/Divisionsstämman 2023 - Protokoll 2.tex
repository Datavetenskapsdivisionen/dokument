...
\subsubsubsection{Förslag till beslut}
Att styrelsen ska skicka in följande offerter

röstning : alla tre eller två av alternativen
Köksväggen + mellanväggen
Mellanväggen
Köksväggen

röstades in att vi ska skicka in tre offerter 

röstning: 
kösväggen + mellan väggen
förslaget godkänt
...
Alla attsatser avslås då styrelsen har rätt att göra redaktionella ändringar i styrdokument som tagits fram av divisionsstämman, enligt punkt 10.3 i stadgan.
...
Yrkesändring: Ändra texten på loggan för att den ska bli mer symmetrisk.
\subsubsection*{Förslag till beslut}
\begin{attsatser}
...
\subsection{Motion: starta ny kommitté DVOps}
...
\subsubsection*{Förslag till beslut}
\begin{attsatser}
    \item Att i avsnittet om kommittéer i reglementet, eller som självständigt dokument i dokumentsamlingen, införa följande

    \begin{displayquote}
        \subsection*{DVOPs}
        \begin{enumerate}[label=\arabic* §]
            \item Kommitténs namn är DVOps.

            \item DVOps arbetar med att främja och göra IT intresset tillgängligt för alla samt agera IT-Avdelning för divisionen och dess lokaler.
...
Samtliga attsatser godkändes.

\subsection{Motion: Inval av DVOps}
Jag föreslår mig själv som ordförande för DVOps.

- Tim “Båtsman” Persson DV'22

\subsubsection*{Förslag till beslut}
\begin{attsatser}
    \item Att välja Tim "Båtsman" Persson till ordförande för DVOps under verksamhetsåret 2023.
\end{attsatser}
...
\subsection{Motion: kostnadsfri uthyrning av skåp till divisionsmedlemmar}

Vi har idag skåp i Monaden, och vi vill få personer som medlemar i divisionen. Varför inte göra det kostnadsfritt för medlemmar, och låta icke-medlemmar betala?

Albin "Slaget" Otterhäll
DV'18

Förslag till beslut

1. Att ConCats tilldelas ansvaret för de mindre skåpen i Monaden.
2. Att divisionsmedlemmar får kostnadsfritt hyra tilldelat skåp (i mån av plats) i Monaden.
3. Att divisionsmedlemmar får förtur framför icke-medlemmar vid skåpstilldelning.
4. Att ConCats sätter ett uthyrningspris på skåpen för icke-medlemmar som gör det rationellt för icke-medlemmar att bli medlemmar.
5. Att Styret till nästa stämma införskaffar eller lånar peruker som ska bäras av samtliga medlemmar i Styret från stämmans öppnande till stämmand avslutande.
