...
Dessa möteshandlingar ska ha skickats ut under måndag den 22e maj.
...
\begin{attsatser}
    ...
    \item införa motionen "kostnadsfri uthyrning av skåp till divisionsmedlemmar" som punkt 4.11 i dagordningen.
\end{attsatser}

Samtliga attsatser godkända.
...
Muntlig verksamhetsrapport av representant från kommittéen.
...
\subsection{Övriga rapporter}
\subsubsection*{Rivning av väggen}
...
Inleds av en muntlig rapport av situationen av Tekla Siesjö.
...
\begin{attsatser}
    ...
    \begin{displayquote}
        Kommittéens namn är ConCats, vilket står för Datavetenskaps arbetsmarkands-kommitté.
    \end{displayquote}
    till
    \begin{displayquote}
        Kommittéens namn är DVArm, vilket står för Datavetenskaps arbetsmarkands-kommitté.
    \end{displayquote}
...
Studienämnden är en ny kommitté som arbetar
med att säkerställa studie -och utbildningskvalitén på programmet. Under en senare stämma valdes det att kommittén skulle namnges Uppdrag,
och vi skulle vilja byta detta till Studienämnd. Vi anser att det är viktigt att kommitténs namn representerar det kommittén jobbar med, och det gör inte namnet
Uppdrag i nuläget.
Detta leder till att studenter som bara ser Uppdrag inte förstår vad kommittén gör vid första blick,
...
\subsubsection*{Förslag till beslut}
\begin{attsatser}
    \item byta namnet på Uppdrag till Studienämnd.
\end{attsatser}


\subsection{Motion: starta ny kommitté DIT1337}
...
Kommittén ska även ansvara för divisionens IT. Då menas bl.a dvet.se och exempelvis
Monadens Wi-Fi.
...
\begin{attsatser}
    ...
    \begin{displayquote}
        ...
        \begin{enumerate}[label=\arabic* §]
            \item Kommitténs namn är DIT1337.

            \item DIT1337 arbetar med att främja och göra IT intresset tillgängligt för alla samt agera IT-Avdelning för divisionen och dess lokaler.
...
\subsection{Motion: Inval av DIT1337}
Jag föreslår mig själv som ordförande för DIT1337.

- Tim “Båtsman” Persson DV'22
\subsubsection*{Förslag till beslut}
\begin{attsatser}
    \item Att välja Tim "Båtsman" Persson till ordförande för DIT1337 under verksamhetsåret 2023.
\end{attsatser}

\subsection{Motion: förtydliga kommittéers uppgift}
Önskar ett förtydligande av kommittéers uppdrag.
Vill att det ska finnas tydliga riktlinjer kring vad de individuella
kommittéernas uppdrag är. Detta för att försäkra att kommittéer uppfyller
sitt syfte och att aktiviteter kommer igång på riktigt.
Tanken är att detta ska träda i kraft vid respektive kommittés nästa verksamhetsråd.

- Tim “Båtsman” Persson DV'22

\subsubsection*{Förslag till beslut}
\begin{attsatser}
    \item Styrelsen utreder rimliga krav och minimum för de relevanta kommittéerna och presenterar detta vid nästa stämma.
    \item Kommittéer diskuterar internt om vad som är rimligt för respektive kommitté och presenterar detta till styret som presenterar på nästa stämma.
    \item Förslaget avslås och stämman anser att inget förtydligande krävs.
\end{attsatser}

\subsection{Motion: skapa ny kommitté Mega 7}
Dear DVD,
I hope this motion finds you in good health and high spirits. I am
writing to propose the establishment of a new committee named Mega
7, realm dedicated of MONADEN.
to the crucial \emoji{sunflower}\emoji{cherry-blossom}\emoji{rose}
task of watering PLANTS in the enchanting
MONADEN, although a place of undeniable beauty, currently thrives
on the presence of PLASTIC PLANTS. While these artificial botanical wonders serve their
...
PLANTS contribute also
to the
play a pivotal role in maintaining BIODIVERSITY, serving as habitats for countless creatures and
...
\subsubsection*{Förslag till beslut}
\begin{attsatser}
    \item Att välja William "Hilliam" Bodin till ordförande för Mega7 under verksamhetsåret 2023.
\end{attsatser}
\newpage

\section{Diskussioner}\label{sec:discussioner}
% Detta är en en ny punkt som lades in förra stämman,
