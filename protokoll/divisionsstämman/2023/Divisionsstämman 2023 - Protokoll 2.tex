...
\subsubsection*{Förslag till beslut}
\begin{attsatser}
    \item Att välja Tim "Båtsman" Persson till ordförande för DV\_Ops under verksamhetsåret 2023.
\end{attsatser}
\subsubsection*{Beslut}
\begin{attsatser}
    \item attsatsen bifalles
...
\begin{attsatser}
	...
	\item Styret till nästa stämma införskaffar eller lånar peruker som ska bäras av samtliga medlemmar i Styret från stämmans öppnande till stämmand avslutande
\end{attsatser}
\subsubsection*{Ändringsyrkanden}
\begin{attsatser}
	...
	\begin{enumerate}
		...
		\item[\textbf{5. Att}] Styret till nästa stämma införskaffar eller lånar peruker som ska bäras av samtliga medlemmar i Styret från stämmans öppnande till stämmand avslutande
	\end{enumerate} till
	\begin{enumerate}
		\item[\textbf{1. Att}] ConCats tilldelas ansvaret för de mindre skåpen i Monaden
		\item[\textbf{2. Att}] divisionsmedlemmar får kostnadsfritt hyra tilldelat skåp (i mån av plats) i Monaden
