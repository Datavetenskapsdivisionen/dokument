#import "Protokoll.typ": protokoll

#protokoll(
  title: "Divisionsstämmans möte 3",
  date: datetime(
    year: 2023,
    month: 11,
    day: 30,
  ...
  protokolJusterare1:  "inga förslag ifrån styrelsen",
  protokolJusterare2:  "inga förslag ifrån styrelsen",
