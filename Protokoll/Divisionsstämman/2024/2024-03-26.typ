...
Den 2024-03-26 kallade styrelsen till divisionsstämma genom att skriva i discordservern MonadenDV, och
att sätta upp affisher i sektionslokalen Monaden.

Detta möteschema ska ha skickats ut under tisdagen den 2024-03-22.
...
- CSEs ledning känner positivt om flytten till Naturvetenskapliga Fakulteten, och ser inte att det kommer ha någon riktigt negativ effekt på utbildning. Detta är sentinent som även är delat av Alex Gerdes (programansvarig för Datavetenskap) och Nils Anders Daniellsson (programansvarig för Computer Science).
...
== ConCats
Concats har efter 2 aspningstillfällen fått fyra nya medlemmar: Nikhil, Daniell, Martin och Samuel.
...
== Proposition: Incident hantering
...
=== Anteckningar
Styrelsen fick in lite frågor och kommer använda detta för att bygga en
enkät.
...
=== Anteckningar
Detta föreslaget var ej populärt, och styrelsen kommer 
med all sannolikhet fortsätta med att ta fram nomineringar
internt.
