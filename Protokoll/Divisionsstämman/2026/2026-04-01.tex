...
\begin{närvarande_medlemmar}
    \medlem{Sarah Manktelow}%[(tillkom/avgick)]
...
\\
\textit{Inga beslutspunkter på agendan inför mötet. }


\subsection*{Motioner}
\textit{Inga motioner har tillkommit inför mötet.}
