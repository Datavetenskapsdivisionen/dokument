...
Styrelsen skulle gärna kunna hålla i en del arrangemang då och då. Kanske i sammarbete med andra föreningar? Tidigare arrangeman (dock endast för styrelsen) har varit en grillkväll med chalmers data. Vad ska styrelsen göra och när?
...
För att främja föreningsen ekonomi och för att skapa ett bättre studentliv vill vi gärna hålla i Kårkällaren oftare. Förslagsvis kan detta göras en gång per termin eller oftare, gärna med en aspppub. Temat bör väljas kollektivt exempelvis genom att skicka ut en enkät.
...
Detta bör delvis utföras med ConCats hjälp/sammarbete
...
Även de DVD märken som sitter på brösfickan av de flesta ovveraller bör köpas in fler av.

=== Förslag till beslut
#attSatser(
  [Samtliga medlemmar försöker designa en/flera patches som presenteras nästa möte och röstas om.],
  [Godtycklig individ kontaktar en märkestillvärkare och köper in X antal DVD märken.]
)
...
Det är rimligt att sittning i för de som tar examen. Denna bör vara en finsittning fär alumner är välkommna samnt studenter innom DVD. Företräde för examenstagande bör ges.
...
=== Förslag till beslut
#attSatser([Godtycklig individ skapar en flik på hemsidan för gamlingar.])
...
=== Förslag till beslut
#attSatser(
  [Godtycklig individ kontaktar relevanta parter och ser till att vi kan och får måla i backen.],
...
=== Förslag till beslut
#attSatser(
  [Godtycklig individ samlar in en lista av intereserade.],
  [Godtycklig individ köper in tejp och delar ut den till intereserade.]
)
