...
har även deltagit på mötet med Petrus och Maximilian.\
Arrangerade fika med semlor under fettisdagen tillsammans med akavia.\

== Kassör
Har tagit emot 3 äskningar.\
Samtalat med före detta kassör om fakturor. fakturering till CSE skall göras klumpvis, gärna inte innan föreningen faktiskt behöver in pengar. Detta är för att underlätta arbetet på CSE:s sida. Pengar finns att täcka utlägg för tillfället.\

== SAMO
Enkäten om studenthälsa har ej skickats ut på mejl som den skulle. Detta åtgärdas direkt.\

== Sekreterare
Har gjort signeringar och inskanningar av tidigare protokoll och fixat protokollet inför detta möte som vanligt.
...
=== Anteckningar
16 svar har kommit in när detta skrivs. På grund av ett misstag har enkäten inte skickats ut via mejl. På grund av detta väljer styrelsen att ta upp denna punkt igen nästa möte.
...
=== Anteckningar
Förslaget är att skaffa en DVI kabel med en HDMI ände så att en kortare HDMI kabel kan användas mellan stereon och änden av DVI-kabeln, som sätts i taket. Nikhil skall kolla på detta vidare och möjligen skicka in en äskan.
...
=== Förslag till beslut:
#attSatser(
  [äskan nr 1 för 300 kr godkänns och skickas till CSE ],
  [äskan nr 2 för 100 kr godkänns och skickas till CSE ]
)
...
== Äskan från Samuel
Samuel har skickat in en äskan. Denna bör beslutas om. Se nedan för själva äskan.

Hej! Vill köpa te, och äskar då för 250kr för att kunna köpa en stor mängd 🪇

=== Förslag till beslut:
#attSatser(
 [äskan på 250 kr för inköp av te, som ska läggas i monaden, godkänns och skickas till CSE],
[styrelsen mejlar Samuel ett starkt ordat mejl om hur en äskan bör formuleras]
)
...
=== Förslag till beslut
#attSatser([styrelsen bordslägger punken till nästa möte då mer information ej finns än.])
...
=== Förslag till beslut:
#attSatser([Nikhil Olsson Mukhopadhyay skapar ett konkret förslag till nästa möte.])

=== Beslut:
#attSatser([attsats 1 bifalles])


== Planering av omsittsen
Då omsittsen är preliminärt planerad 12:e april bör seriös planering påbörjas snarast. Beslut bör fattas om ansvarsområden och planering bör starta.
=== Förslag till beslut:
#attSatser(
...
OOP6 har föreslagit ett gemensamt event. Detta är så klar något positivt och styrelsen bör skicka detta vidare till relevanta kommittéer.
=== Förslag till beslut:
