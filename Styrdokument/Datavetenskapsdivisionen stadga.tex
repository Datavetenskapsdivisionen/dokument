...
\begin{document}
	...
	\date{Senast uppdaterad: 2025-01-30}
	...
	\begin{description}
		...
		\item[NaT-sektionen] Natur- och Teknik-sektionen vid Göta studentkår.

		\item[kandidatprogrammet] Kandidatprogrammet \emph{Datavetenskapligt program} vid \emph{Göteborgs universitet}.

		\item[kåren] \emph{Göta studentkår} (857200-4144)
		...
		\item[läsdag] Veckodag från och med måndag till och med fredag under läsåret.
					  De dagar som är arbetsfria enligt Chalmers kollektivavtal räknas inte som läsdagar.
	...
	\begin{enumerate}[label=\arabic* §, ref=\arabic*]
		...
		Vid översättning till engelska ska divisionens namn översättas till \emph{Computer Science Division}.
	...
	\begin{enumerate}[label=\arabic* §, ref=\arabic*]
		...
		\item Styrelsen ansvarar för administrationen av medlemskap i divisionen.
	...
	\begin{enumerate}[label=\arabic* §, ref=\arabic*]
		...
		\item I föreningen gäller reglerna för ansvar och ansvarsfrihet enligt 21 kap. i Lag (2018:672) om ekonomiska föreningar.
	...
	\begin{enumerate}[label=\arabic* §, ref=\arabic*]
		...
		\item Senast dagen före ett nytt räkenskapsår börjar ska divisionsstämman beslutat om tillräckligt många styrelsemedlemmar för att styrelsen ska vara beslutsfattig för det kommande räkenskapsåret.
	...
	\begin{enumerate}[label=\arabic* §, ref=\arabic*]
		...
		% 11 §
		\item Styrelsens sammanträden måste kallas minst två läsdagar innan sammanträdet. Kallelsen ska innehålla:

		\begin{itemize}
			\item vilket styrelsesammanträde i ordningen som kallas till;
			\item när det signerade protokollet som senast ska vara tillgängligt för medlemmarna;
			\item tid och datum för sammanträdet;
			\item plats för sammanträdet.
		\end{itemize}

		Kallelsen ska ske med
		
		\begin{itemize}
			\item en kallelse på Discordservern MonadenDV;
			\item en kallelse på dvet.se.
		\end{itemize}
		...
		% 12 §
		\item När per capsulam-beslut har fattats måste beslutet dokumenteras
		
		\begin{itemize}
			\item på divisionens Discordserver som är tillgänglig alla studenter;
			\item i protokollet för det första styrelsesammanträdet efter beslut har fattats.
		\end{itemize}
		
		Dokumentationen ska innehålla
		
		\begin{itemize}
			\item vilka att-satser som har bifallits;
			\item omröstningsperioden.
		\end{itemize}
	...
	\section{Avgång, avstängning eller avsättning}
	...
	\begin{enumerate}[label=\arabic* §, ref=\arabic*]
		...
		\begin{enumerate}[label=\theenumi~\alph* §, ref=\theenumi~\alph*]
			\item Vid ordförandes avgång eller avsättning ska vice ordförande ta upp ordförandes arbetsuppgifter och rättigheter, tills dess att divisionsstämman utser en ny ordförande.
		...
		\begin{itemize}
			\item stänga av enskild medlem från deras förtroendeuppdrag endast om medlemmen inte är revisor.
		\end{itemize}
		...
		Om inte misstroendeförklaringen går igenom hävs avstängningen.
	...
	\begin{enumerate}[label=\arabic* §, ref=\arabic*]
		...
		Det måste vara minst 10 läsdagar mellan sammanträdena.

		Antagen ändring av dessa dokument träder i kraft omedelbart under innevarande sammanträde av divisionsstämman.
		...
		Om det uppstår en tvist om hur man ska tolka dokument där endast divisionsstämman kan besluta om ändringar tolkas dokumentet av revisor för avgörande. I händelsen av att det inte finns en revisor tolkas dokumentet av divisionsordförande.
		...
		Med styrdokument menas dokument som konkret reglerar föreningens verksamhet.
	...
	\begin{enumerate}[label=\arabic* §, ref=\arabic*]
		...
		Därefter ska kvarvarande och icke-ekonomiska tillgångar förvaras av Göta studentkårs NaT-sektion för användning endast till framtida studentorganisationer för datavetenskap vid \emph{Göteborgs universitet}.
